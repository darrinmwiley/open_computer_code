...
print("fetching bonsai control")
wget("https://raw.githubusercontent.com/darrinmwiley/open_computer_code/master/bonsai_factory/set_bonsai.lua", "set_bonsai.lua", true, true)
print("fetching listeners")
wget("https://raw.githubusercontent.com/darrinmwiley/open_computer_code/master/bonsai_factory/listen_west.lua", "listen_west.lua", true, true)
wget("https://raw.githubusercontent.com/darrinmwiley/open_computer_code/master/bonsai_factory/listen_east.lua", "listen_east.lua", true, true)
wget("https://raw.githubusercontent.com/darrinmwiley/open_computer_code/master/bonsai_factory/listen_north.lua", "listen_north.lua", true, true)
wget("https://raw.githubusercontent.com/darrinmwiley/open_computer_code/master/bonsai_factory/listen_south.lua", "listen_south.lua", true, true)
